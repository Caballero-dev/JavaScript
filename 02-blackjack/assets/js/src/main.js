import { createDeck, requestCard, cardValue } from './deck.js'
import { updatePoints, createCard, resetPoints, clearCards, showResult } from './ui.js'
...
const accumulatePoints = ( card, playerTurn ) => {
  ...
  updatePoints(playersPoints[playerTurn], playerTurn);
